...
const GREETING_SUB = {
  ...
  morning: '오늘도 주님의 은혜 안에서 함께 걸어요.',
  afternoon: '바쁜 오후네요. 주님이 주시는 평안 속에서 잠시 쉬어가세요.',
  evening: '오늘도 애쓰셨습니다. 주님의 평안을 깊이 누리는 저녁 되시길 바랍니다.',
  night: '하루의 끝자락, 주님의 평강 속에 모든 것을 내려놓으시고 편안한 밤 되세요',
} as const;
...
export default function HomeScreen() {
  ...
  // 아니라 온라인 중계도 없다.
  const { serviceHeading: latestServiceHeading } = useLatestBulletinWeekInfo(isSunday);
  const isSingleServiceWeek = !!latestServiceHeading;
