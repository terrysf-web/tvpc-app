 ...
 * 글자(한글 이름은 물론, José·François처럼 한글·영문 알파벳이 아닌 외국
 * 이름도 다 포함해서 — \p{L}이 언어 구분 없이 모든 문자를 잡는다)·
 * 띄어쓰기·가운뎃점(복수 이름 "김성도·이믿음")·붙임표·어퍼스트로피
 * (Mary-Jane, O'Brien)만 남기고 나머지는 입력하는 순간 걸러낸다. */
