...
import { useRecentVerses } from '../data/hooks';
import { saveUrlToDevice } from '../links';
import { canManageSermonAudio } from '../roles';
...
/**
 * 새벽설교 목록 — 홈 말씀 카드는 오늘 것 하나만 보여주므로, 어제 이전의
 * 말씀과 그날 설교 녹음은 이 목록에서 찾아 듣는다. 설교 탭의 "새벽설교"에
 * 들어간다.
 *
 ...
 * 안 나온다.
 */
export function DawnSermonList() {
